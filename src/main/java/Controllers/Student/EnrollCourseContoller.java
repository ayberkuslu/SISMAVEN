...
public class EnrollCourseContoller extends Controller {
    ...
    public void enrollCourse() {
        ...
        try {
            ...
            getSession().save(new Logs(Logs.COURSE_ENROLL, "enrolled course", currentUser, new Date()));
    ...
    public void derollCourse() {
        ...
        try {
            ...
            getSession().save(new Logs(Logs.COURSE_DEROLL, "derolled course", currentUser, new Date()));
